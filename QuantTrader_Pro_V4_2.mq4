...
#property strict
#property description "全自动多策略量化交易系统 V4.2 [智能双模网格 + 三重风控]"
...
string   g_ObjPrefix="QT42_";
string   g_ToggleName="QT42_TogglePanel";
...
ProductConfig g_ProductCfg;  // V4.2 产品配置
TierConfig    g_TierCfg;     // V4.2 资金层级配置
...
void DrawDashboard() {
   ...
   int w=480, h=720, headerH=40, pad=18;  // V4.2 深度扩容面板
   int cy=y+headerH+16;
   ...
   CreateLabel("T_Ver", "V4.2", x+w-46, y+9, g_ColorMuted, 9, "Consolas");
